...
type WikiSpec struct {
	...
	// Foo is an example field of Wiki. Edit wiki_types.go to remove/update
...
// Wiki is the Schema for the wikis API.
type Wiki struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   WikiSpec   `json:"spec,omitempty"`
	Status WikiStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// WikiList contains a list of Wiki.
